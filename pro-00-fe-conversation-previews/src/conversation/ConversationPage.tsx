...
import conversationPreviewServiceSolution02 from "./ConversationPreviewServiceSolution02";
...
const ConversationPage = (): JSX.Element => {
  ...
  const processLogin = async (localUserIdentity: string, retryTimes: number) => {
    try {
      ...
      console.time("LoadConversations_"+localUserIdentity);
      const cachedConversations = await conversationPreviewServiceSolution02.loadConversationPreviews(localUserIdentity);
      console.timeLog("LoadConversations_"+localUserIdentity);
      console.log('Total conversations: '+cachedConversations.length);
        ...
        <div className={'row bg-light'}>
          <div className={'col-3 conversations-list'}>
            ...
            {existingConversations.map((cachedConversation: CachedConversation) => (
              <ConversationPreview key={cachedConversation.conversation.sid} localParticipantIdentity={localUserIdentity}
